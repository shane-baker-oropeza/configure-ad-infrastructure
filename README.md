...
<p>
Step 2: Domain Controller (DC-1) Setup.  Create a Virtual Machine named DC-1 running Windows Server 2022.
...
Log into Client-1.
Open a command prompt and ping DC-1’s private IP address to ensure the connection is successful.
